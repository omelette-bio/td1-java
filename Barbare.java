public class Barbare extends Metier{
  ...
  Barbare() {
    ...
    this.sorts[0] = new Sort("Grizzly Bear Death Choke", "vous passez derrière votre ennemi pour lui broyer le cou", 4);
    this.sorts[1] = new Sort("Rhino Charge Rib Breaker", "vous foncez dans votre ennemi, broyant ses côtes", 15);
